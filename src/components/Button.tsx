...
export default function Button({
  ...
  const buttonClasses = {
    ...
    search: `${disabledClasses} w-28 h-8 text-xs text-sm text-gray-900 focus:outline-none bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200`,
